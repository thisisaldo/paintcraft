...
export const metadata: Metadata = {
  ...
  description:
    "Melbourne's trusted painting specialists. Expert residential and commercial painters serving South Yarra, Toorak, Richmond, Carlton, Fitzroy, Brighton and all Melbourne suburbs. Licensed, insured, 15+ years experience.",
  keywords: [
    'painters Melbourne',
